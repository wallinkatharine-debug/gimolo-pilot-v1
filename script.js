...
function wireMain(){
  ...
  $("keepBtn").addEventListener("click",()=>{beep("click"); microHaptic(); state.steer="keep"; toast("Keeping the vibe."); spinToNext();});
  $("switchBtn").addEventListener("click",()=>{beep("click"); microHaptic(); state.steer="switch"; toast("Switching tone."); spinToNext();});
  $("surpriseBtn").addEventListener("click",()=>{beep("click"); microHaptic(); state.steer="surprise"; toast("Surprise mode."); spinToNext();});
